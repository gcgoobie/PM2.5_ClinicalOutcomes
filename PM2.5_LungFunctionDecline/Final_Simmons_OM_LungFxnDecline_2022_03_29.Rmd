---
title: "OM and fibrotic ILD Complete Cohort Lung Function Decline Analysis - Updated First Encounter Date"
...
```{r}
outfile2 <- here("Final_Simmons_fILD_OM_BaselineData_2022_03_29.xlsx")
...
### Partial Model
```{r}
FVC_lmer2 <- lmer(fvc_pct ~ 1 + time_firstPFT*OM_5yrPreCensor + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer2)
icc(FVC_lmer2)
report(FVC_lmer2)
```
...
### Complete Model
```{r}
FVC_lmer3 <- lmer(fvc_pct ~ 1 + time_firstPFT*OM_5yrPreCensor + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer3)
icc(FVC_lmer3)
report(FVC_lmer3)
```
...
### Partial Model
```{r}
FVC_lmer5 <- lmer(fvc_pct ~ 1 + time_firstPFT*OM5yrCensor_dich + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer5)
icc(FVC_lmer5)
report(FVC_lmer5)
```
...
### Complete Model
```{r}
FVC_lmer6 <- lmer(fvc_pct ~ 1 + time_firstPFT*OM5yrCensor_dich + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer6)
icc(FVC_lmer6)
report(FVC_lmer6)
```
...
### Partial Model
```{r}
dlco_lmer2 <- lmer(dlco_pct ~ 1 + time_firstPFT*OM_5yrPreCensor + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer2)
icc(dlco_lmer2)
report(dlco_lmer2)
```
...
### Complete Model
```{r}
dlco_lmer3 <- lmer(dlco_pct ~ 1 + time_firstPFT*OM_5yrPreCensor + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer3)
icc(dlco_lmer3)
report(dlco_lmer3)
```
...
### Partial Model
```{r}
dlco_lmer5 <- lmer(dlco_pct ~ 1 + time_firstPFT*OM5yrCensor_dich + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer5)
icc(dlco_lmer5)
report(dlco_lmer5)
```
...
### Complete Model
```{r}
dlco_lmer6 <- lmer(dlco_pct ~ 1 + time_firstPFT*OM5yrCensor_dich + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer6)
icc(dlco_lmer6)
report(dlco_lmer6)
```
