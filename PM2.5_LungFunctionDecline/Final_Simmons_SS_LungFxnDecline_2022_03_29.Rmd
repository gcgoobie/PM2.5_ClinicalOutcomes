---
title: "SS and fibrotic ILD Complete Cohort Lung Function Decline Analysis - Updated First Encounter Date"
...
```{r}
outfile2 <- here("Final_Simmons_fILD_SS_BaselineData_2022_03_29.xlsx")
...
### Complete Model
```{r}
FVC_lmer3 <- lmer(fvc_pct ~ 1 + time_firstPFT*SS_5yrPreCensor + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer3)
icc(FVC_lmer3)
report(FVC_lmer3)
```
...
### Complete Model
```{r}
FVC_lmer6 <- lmer(fvc_pct ~ 1 + time_firstPFT*SS5yrCensor_dich + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT| ID), data=pft)
summary(FVC_lmer6)
icc(FVC_lmer6)
report(FVC_lmer6)
```
...
### Complete Model
```{r}
dlco_lmer3 <- lmer(dlco_pct ~ 1 + time_firstPFT*SS_5yrPreCensor + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer3)
icc(dlco_lmer3)
report(dlco_lmer3)
```
...
### Complete Model
```{r}
dlco_lmer6 <- lmer(dlco_pct ~ 1 + time_firstPFT*SS5yrCensor_dich + time_firstPFT*nat_ADI + time_firstPFT*dich_Race + time_firstPFT*sex + time_firstPFT*age_dx + time_firstPFT*smokeHx + time_firstPFT*dx_IPF + time_firstPFT*metro + (1 + time_firstPFT | ID), data=pft)
summary(dlco_lmer6)
icc(dlco_lmer6)
report(dlco_lmer6)
```
