...
```{r}
outfile1 <- here::here("MonthlyNH4Data/Simmons_fILDPts_BaselineData_2021_05_05.xlsx")
...
Simm_NH4_2000 <- left_join(match, df_jan00, by="nrow")
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_jan00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_feb00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_feb00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_mar00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_mar00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_apr00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_apr00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_may00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_may00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_jun00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_jun00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_jul00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_jul00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_aug00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_aug00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_sep00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_sep00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_oct00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_oct00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_nov00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_nov00"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2000 <- left_join(Simm_NH4_2000, df_dec00, by=c("nrow","lon","lat"))
str(Simm_NH4_2000)
Simm_NH4_2000 <- Simm_NH4_2000 %>% rename(c("NH4_dec00"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2000, path="Simm_fILD_2000_NH4_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(match, df_jan01, by="nrow")
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_jan01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_feb01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_feb01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_mar01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_mar01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_apr01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_apr01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_may01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_may01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_jun01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_jun01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_jul01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_jul01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_aug01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_aug01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_sep01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_sep01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_oct01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_oct01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_nov01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_nov01"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2001 <- left_join(Simm_NH4_2001, df_dec01, by=c("nrow","lon","lat"))
str(Simm_NH4_2001)
Simm_NH4_2001 <- Simm_NH4_2001 %>% rename(c("NH4_dec01"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2001, path="Simm_fILD_2001_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(match, df_jan02, by="nrow")
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_jan02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_feb02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_feb02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_mar02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_mar02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_apr02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_apr02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_may02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_may02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_jun02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_jun02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_jul02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_jul02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_aug02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_aug02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_sep02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_sep02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_oct02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_oct02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_nov02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_nov02"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2002 <- left_join(Simm_NH4_2002, df_dec02, by=c("nrow","lon","lat"))
str(Simm_NH4_2002)
Simm_NH4_2002 <- Simm_NH4_2002 %>% rename(c("NH4_dec02"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2002, path="Simm_fILD_2002_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(match, df_jan03, by="nrow")
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_jan03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_feb03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_feb03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_mar03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_mar03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_apr03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_apr03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_may03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_may03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_jun03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_jun03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_jul03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_jul03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_aug03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_aug03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_sep03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_sep03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_oct03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_oct03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_nov03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_nov03"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2003 <- left_join(Simm_NH4_2003, df_dec03, by=c("nrow","lon","lat"))
str(Simm_NH4_2003)
Simm_NH4_2003 <- Simm_NH4_2003 %>% rename(c("NH4_dec03"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2003, path="Simm_fILD_2003_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(match, df_jan04, by="nrow")
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_jan04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_feb04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_feb04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_mar04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_mar04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_apr04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_apr04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_may04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_may04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_jun04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_jun04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_jul04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_jul04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_aug04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_aug04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_sep04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_sep04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_oct04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_oct04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_nov04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_nov04"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2004 <- left_join(Simm_NH4_2004, df_dec04, by=c("nrow","lon","lat"))
str(Simm_NH4_2004)
Simm_NH4_2004 <- Simm_NH4_2004 %>% rename(c("NH4_dec04"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2004, path="Simm_fILD_2004_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(match, df_jan05, by="nrow")
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_jan05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_feb05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_feb05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_mar05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_mar05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_apr05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_apr05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_may05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_may05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_jun05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_jun05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_jul05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_jul05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_aug05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_aug05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_sep05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_sep05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_oct05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_oct05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_nov05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_nov05"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2005 <- left_join(Simm_NH4_2005, df_dec05, by=c("nrow","lon","lat"))
str(Simm_NH4_2005)
Simm_NH4_2005 <- Simm_NH4_2005 %>% rename(c("NH4_dec05"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2005, path="Simm_fILD_2005_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(match, df_jan06, by="nrow")
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_jan06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_feb06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_feb06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_mar06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_mar06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_apr06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_apr06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_may06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_may06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_jun06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_jun06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_jul06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_jul06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_aug06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_aug06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_sep06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_sep06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_oct06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_oct06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_nov06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_nov06"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2006 <- left_join(Simm_NH4_2006, df_dec06, by=c("nrow","lon","lat"))
str(Simm_NH4_2006)
Simm_NH4_2006 <- Simm_NH4_2006 %>% rename(c("NH4_dec06"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2006, path="Simm_fILD_2006_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(match, df_jan07, by="nrow")
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_jan07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_feb07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_feb07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_mar07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_mar07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_apr07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_apr07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_may07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_may07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_jun07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_jun07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_jul07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_jul07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_aug07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_aug07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_sep07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_sep07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_oct07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_oct07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_nov07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_nov07"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2007 <- left_join(Simm_NH4_2007, df_dec07, by=c("nrow","lon","lat"))
str(Simm_NH4_2007)
Simm_NH4_2007 <- Simm_NH4_2007 %>% rename(c("NH4_dec07"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2007, path="Simm_fILD_2007_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(match, df_jan08, by="nrow")
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_jan08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_feb08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_feb08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_mar08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_mar08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_apr08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_apr08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_may08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_may08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_jun08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_jun08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_jul08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_jul08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_aug08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_aug08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_sep08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_sep08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_oct08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_oct08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_nov08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_nov08"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2008 <- left_join(Simm_NH4_2008, df_dec08, by=c("nrow","lon","lat"))
str(Simm_NH4_2008)
Simm_NH4_2008 <- Simm_NH4_2008 %>% rename(c("NH4_dec08"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2008, path="Simm_fILD_2008_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(match, df_jan09, by="nrow")
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_jan09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_feb09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_feb09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_mar09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_mar09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_apr09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_apr09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_may09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_may09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_jun09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_jun09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_jul09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_jul09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_aug09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_aug09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_sep09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_sep09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_oct09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_oct09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_nov09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_nov09"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2009 <- left_join(Simm_NH4_2009, df_dec09, by=c("nrow","lon","lat"))
str(Simm_NH4_2009)
Simm_NH4_2009 <- Simm_NH4_2009 %>% rename(c("NH4_dec09"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2009, path="Simm_fILD_2009_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(match, df_jan10, by="nrow")
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_jan10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_feb10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_feb10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_mar10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_mar10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_apr10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_apr10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_may10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_may10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_jun10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_jun10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_jul10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_jul10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_aug10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_aug10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_sep10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_sep10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_oct10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_oct10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_nov10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_nov10"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2010 <- left_join(Simm_NH4_2010, df_dec10, by=c("nrow","lon","lat"))
str(Simm_NH4_2010)
Simm_NH4_2010 <- Simm_NH4_2010 %>% rename(c("NH4_dec10"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2010, path="Simm_fILD_2010_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(match, df_jan11, by="nrow")
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_jan11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_feb11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_feb11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_mar11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_mar11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_apr11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_apr11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_may11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_may11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_jun11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_jun11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_jul11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_jul11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_aug11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_aug11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_sep11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_sep11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_oct11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_oct11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_nov11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_nov11"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2011 <- left_join(Simm_NH4_2011, df_dec11, by=c("nrow","lon","lat"))
str(Simm_NH4_2011)
Simm_NH4_2011 <- Simm_NH4_2011 %>% rename(c("NH4_dec11"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2011, path="Simm_fILD_2011_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(match, df_jan12, by="nrow")
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_jan12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_feb12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_feb12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_mar12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_mar12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_apr12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_apr12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_may12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_may12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_jun12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_jun12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_jul12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_jul12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_aug12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_aug12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_sep12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_sep12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_oct12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_oct12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_nov12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_nov12"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2012 <- left_join(Simm_NH4_2012, df_dec12, by=c("nrow","lon","lat"))
str(Simm_NH4_2012)
Simm_NH4_2012 <- Simm_NH4_2012 %>% rename(c("NH4_dec12"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2012, path="Simm_fILD_2012_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(match, df_jan13, by="nrow")
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_jan13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_feb13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_feb13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_mar13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_mar13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_apr13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_apr13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_may13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_may13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_jun13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_jun13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_jul13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_jul13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_aug13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_aug13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_sep13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_sep13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_oct13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_oct13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_nov13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_nov13"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2013 <- left_join(Simm_NH4_2013, df_dec13, by=c("nrow","lon","lat"))
str(Simm_NH4_2013)
Simm_NH4_2013 <- Simm_NH4_2013 %>% rename(c("NH4_dec13"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2013, path="Simm_fILD_2013_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(match, df_jan14, by="nrow")
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_jan14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_feb14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_feb14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_mar14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_mar14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_apr14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_apr14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_may14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_may14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_jun14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_jun14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_jul14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_jul14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_aug14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_aug14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_sep14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_sep14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_oct14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_oct14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_nov14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_nov14"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2014 <- left_join(Simm_NH4_2014, df_dec14, by=c("nrow","lon","lat"))
str(Simm_NH4_2014)
Simm_NH4_2014 <- Simm_NH4_2014 %>% rename(c("NH4_dec14"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2014, path="Simm_fILD_2014_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(match, df_jan15, by="nrow")
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_jan15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_feb15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_feb15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_mar15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_mar15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_apr15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_apr15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_may15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_may15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_jun15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_jun15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_jul15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_jul15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_aug15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_aug15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_sep15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_sep15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_oct15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_oct15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_nov15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_nov15"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2015 <- left_join(Simm_NH4_2015, df_dec15, by=c("nrow","lon","lat"))
str(Simm_NH4_2015)
Simm_NH4_2015 <- Simm_NH4_2015 %>% rename(c("NH4_dec15"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2015, path="Simm_fILD_2015_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(match, df_jan16, by="nrow")
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_jan16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_feb16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_feb16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_mar16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_mar16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_apr16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_apr16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_may16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_may16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_jun16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_jun16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_jul16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_jul16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_aug16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_aug16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_sep16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_sep16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_oct16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_oct16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_nov16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_nov16"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2016 <- left_join(Simm_NH4_2016, df_dec16, by=c("nrow","lon","lat"))
str(Simm_NH4_2016)
Simm_NH4_2016 <- Simm_NH4_2016 %>% rename(c("NH4_dec16"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2016, path="Simm_fILD_2016_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(match, df_jan17, by="nrow")
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_jan17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_feb17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_feb17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_mar17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_mar17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_apr17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_apr17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_may17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_may17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_jun17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_jun17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_jul17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_jul17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_aug17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_aug17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_sep17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_sep17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_oct17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_oct17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_nov17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_nov17"="NH4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
Simm_NH4_2017 <- left_join(Simm_NH4_2017, df_dec17, by=c("nrow","lon","lat"))
str(Simm_NH4_2017)
Simm_NH4_2017 <- Simm_NH4_2017 %>% rename(c("NH4_dec17"="NH4"))
```
...
```{r}
write_xlsx(Simm_NH4_2017, path="Simm_fILD_2017_NH4_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Combine all Simm_NH4 files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
Simm_NH4 <- list(Simm_NH4_2000, Simm_NH4_2001, Simm_NH4_2002, Simm_NH4_2003, Simm_NH4_2004, Simm_NH4_2005, Simm_NH4_2006, Simm_NH4_2007, Simm_NH4_2008, Simm_NH4_2009, Simm_NH4_2010, Simm_NH4_2011, Simm_NH4_2012, Simm_NH4_2013, Simm_NH4_2014, Simm_NH4_2015, Simm_NH4_2016, Simm_NH4_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(Simm_NH4, path="Simm_fILD_2000_2017_NH4_2021_11_05.xlsx")
```
