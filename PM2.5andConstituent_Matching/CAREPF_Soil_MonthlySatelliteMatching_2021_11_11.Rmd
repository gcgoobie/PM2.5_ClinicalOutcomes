...
```{r}
outfile1 <- here::here("MonthlysoilData/CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_soil_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_jan00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_feb00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_mar00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_apr00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_may00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_jun00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_jul00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_aug00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_sep00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_oct00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_nov00"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2000 <- left_join(CARE_soil_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_soil_2000)
CARE_soil_2000 <- CARE_soil_2000 %>% rename(c("soil_dec00"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2000, path="CARE_fILD_2000_soil_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_jan01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_feb01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_mar01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_apr01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_may01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_jun01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_jul01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_aug01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_sep01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_oct01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_nov01"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2001 <- left_join(CARE_soil_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_soil_2001)
CARE_soil_2001 <- CARE_soil_2001 %>% rename(c("soil_dec01"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2001, path="CARE_fILD_2001_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_jan02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_feb02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_mar02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_apr02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_may02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_jun02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_jul02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_aug02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_sep02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_oct02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_nov02"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2002 <- left_join(CARE_soil_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_soil_2002)
CARE_soil_2002 <- CARE_soil_2002 %>% rename(c("soil_dec02"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2002, path="CARE_fILD_2002_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_jan03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_feb03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_mar03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_apr03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_may03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_jun03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_jul03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_aug03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_sep03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_oct03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_nov03"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2003 <- left_join(CARE_soil_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_soil_2003)
CARE_soil_2003 <- CARE_soil_2003 %>% rename(c("soil_dec03"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2003, path="CARE_fILD_2003_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_jan04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_feb04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_mar04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_apr04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_may04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_jun04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_jul04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_aug04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_sep04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_oct04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_nov04"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2004 <- left_join(CARE_soil_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_soil_2004)
CARE_soil_2004 <- CARE_soil_2004 %>% rename(c("soil_dec04"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2004, path="CARE_fILD_2004_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_jan05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_feb05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_mar05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_apr05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_may05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_jun05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_jul05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_aug05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_sep05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_oct05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_nov05"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2005 <- left_join(CARE_soil_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_soil_2005)
CARE_soil_2005 <- CARE_soil_2005 %>% rename(c("soil_dec05"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2005, path="CARE_fILD_2005_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_jan06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_feb06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_mar06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_apr06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_may06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_jun06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_jul06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_aug06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_sep06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_oct06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_nov06"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2006 <- left_join(CARE_soil_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_soil_2006)
CARE_soil_2006 <- CARE_soil_2006 %>% rename(c("soil_dec06"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2006, path="CARE_fILD_2006_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_jan07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_feb07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_mar07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_apr07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_may07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_jun07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_jul07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_aug07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_sep07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_oct07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_nov07"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2007 <- left_join(CARE_soil_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_soil_2007)
CARE_soil_2007 <- CARE_soil_2007 %>% rename(c("soil_dec07"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2007, path="CARE_fILD_2007_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_jan08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_feb08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_mar08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_apr08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_may08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_jun08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_jul08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_aug08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_sep08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_oct08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_nov08"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2008 <- left_join(CARE_soil_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_soil_2008)
CARE_soil_2008 <- CARE_soil_2008 %>% rename(c("soil_dec08"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2008, path="CARE_fILD_2008_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_jan09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_feb09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_mar09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_apr09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_may09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_jun09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_jul09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_aug09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_sep09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_oct09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_nov09"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2009 <- left_join(CARE_soil_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_soil_2009)
CARE_soil_2009 <- CARE_soil_2009 %>% rename(c("soil_dec09"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2009, path="CARE_fILD_2009_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_jan10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_feb10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_mar10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_apr10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_may10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_jun10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_jul10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_aug10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_sep10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_oct10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_nov10"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2010 <- left_join(CARE_soil_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_soil_2010)
CARE_soil_2010 <- CARE_soil_2010 %>% rename(c("soil_dec10"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2010, path="CARE_fILD_2010_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_jan11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_feb11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_mar11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_apr11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_may11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_jun11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_jul11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_aug11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_sep11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_oct11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_nov11"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2011 <- left_join(CARE_soil_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_soil_2011)
CARE_soil_2011 <- CARE_soil_2011 %>% rename(c("soil_dec11"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2011, path="CARE_fILD_2011_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_jan12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_feb12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_mar12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_apr12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_may12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_jun12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_jul12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_aug12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_sep12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_oct12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_nov12"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2012 <- left_join(CARE_soil_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_soil_2012)
CARE_soil_2012 <- CARE_soil_2012 %>% rename(c("soil_dec12"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2012, path="CARE_fILD_2012_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_jan13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_feb13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_mar13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_apr13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_may13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_jun13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_jul13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_aug13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_sep13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_oct13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_nov13"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2013 <- left_join(CARE_soil_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_soil_2013)
CARE_soil_2013 <- CARE_soil_2013 %>% rename(c("soil_dec13"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2013, path="CARE_fILD_2013_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_jan14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_feb14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_mar14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_apr14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_may14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_jun14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_jul14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_aug14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_sep14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_oct14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_nov14"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2014 <- left_join(CARE_soil_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_soil_2014)
CARE_soil_2014 <- CARE_soil_2014 %>% rename(c("soil_dec14"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2014, path="CARE_fILD_2014_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_jan15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_feb15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_mar15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_apr15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_may15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_jun15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_jul15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_aug15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_sep15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_oct15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_nov15"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2015 <- left_join(CARE_soil_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_soil_2015)
CARE_soil_2015 <- CARE_soil_2015 %>% rename(c("soil_dec15"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2015, path="CARE_fILD_2015_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_jan16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_feb16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_mar16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_apr16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_may16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_jun16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_jul16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_aug16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_sep16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_oct16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_nov16"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2016 <- left_join(CARE_soil_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_soil_2016)
CARE_soil_2016 <- CARE_soil_2016 %>% rename(c("soil_dec16"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2016, path="CARE_fILD_2016_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_jan17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_feb17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_mar17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_apr17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_may17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_jun17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_jul17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_aug17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_sep17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_oct17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_nov17"="SOIL"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_soil_2017 <- left_join(CARE_soil_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_soil_2017)
CARE_soil_2017 <- CARE_soil_2017 %>% rename(c("soil_dec17"="SOIL"))
```
...
```{r}
write_xlsx(CARE_soil_2017, path="CARE_fILD_2017_soil_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Csoilbine all CARE_soil files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_soil <- list(CARE_soil_2000, CARE_soil_2001, CARE_soil_2002, CARE_soil_2003, CARE_soil_2004, CARE_soil_2005, CARE_soil_2006, CARE_soil_2007, CARE_soil_2008, CARE_soil_2009, CARE_soil_2010, CARE_soil_2011, CARE_soil_2012, CARE_soil_2013, CARE_soil_2014, CARE_soil_2015, CARE_soil_2016, CARE_soil_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_soil, path="CARE_fILD_2000_2017_soil_2021_11_05.xlsx")
```
