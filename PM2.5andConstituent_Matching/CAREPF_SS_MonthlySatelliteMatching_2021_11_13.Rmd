...
```{r}
outfile1 <- here::here("MonthlySSData/CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_SS_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_jan00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_feb00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_mar00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_apr00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_may00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_jun00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_jul00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_aug00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_sep00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_oct00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_nov00"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2000 <- left_join(CARE_SS_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_SS_2000)
CARE_SS_2000 <- CARE_SS_2000 %>% rename(c("SS_dec00"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2000, path="CARE_fILD_2000_SS_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_jan01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_feb01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_mar01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_apr01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_may01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_jun01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_jul01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_aug01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_sep01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_oct01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_nov01"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2001 <- left_join(CARE_SS_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_SS_2001)
CARE_SS_2001 <- CARE_SS_2001 %>% rename(c("SS_dec01"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2001, path="CARE_fILD_2001_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_jan02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_feb02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_mar02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_apr02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_may02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_jun02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_jul02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_aug02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_sep02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_oct02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_nov02"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2002 <- left_join(CARE_SS_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_SS_2002)
CARE_SS_2002 <- CARE_SS_2002 %>% rename(c("SS_dec02"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2002, path="CARE_fILD_2002_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_jan03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_feb03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_mar03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_apr03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_may03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_jun03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_jul03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_aug03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_sep03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_oct03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_nov03"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2003 <- left_join(CARE_SS_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_SS_2003)
CARE_SS_2003 <- CARE_SS_2003 %>% rename(c("SS_dec03"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2003, path="CARE_fILD_2003_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_jan04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_feb04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_mar04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_apr04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_may04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_jun04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_jul04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_aug04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_sep04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_oct04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_nov04"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2004 <- left_join(CARE_SS_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_SS_2004)
CARE_SS_2004 <- CARE_SS_2004 %>% rename(c("SS_dec04"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2004, path="CARE_fILD_2004_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_jan05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_feb05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_mar05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_apr05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_may05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_jun05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_jul05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_aug05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_sep05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_oct05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_nov05"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2005 <- left_join(CARE_SS_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_SS_2005)
CARE_SS_2005 <- CARE_SS_2005 %>% rename(c("SS_dec05"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2005, path="CARE_fILD_2005_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_jan06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_feb06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_mar06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_apr06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_may06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_jun06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_jul06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_aug06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_sep06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_oct06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_nov06"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2006 <- left_join(CARE_SS_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_SS_2006)
CARE_SS_2006 <- CARE_SS_2006 %>% rename(c("SS_dec06"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2006, path="CARE_fILD_2006_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_jan07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_feb07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_mar07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_apr07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_may07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_jun07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_jul07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_aug07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_sep07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_oct07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_nov07"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2007 <- left_join(CARE_SS_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_SS_2007)
CARE_SS_2007 <- CARE_SS_2007 %>% rename(c("SS_dec07"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2007, path="CARE_fILD_2007_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_jan08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_feb08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_mar08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_apr08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_may08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_jun08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_jul08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_aug08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_sep08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_oct08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_nov08"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2008 <- left_join(CARE_SS_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_SS_2008)
CARE_SS_2008 <- CARE_SS_2008 %>% rename(c("SS_dec08"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2008, path="CARE_fILD_2008_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_jan09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_feb09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_mar09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_apr09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_may09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_jun09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_jul09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_aug09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_sep09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_oct09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_nov09"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2009 <- left_join(CARE_SS_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_SS_2009)
CARE_SS_2009 <- CARE_SS_2009 %>% rename(c("SS_dec09"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2009, path="CARE_fILD_2009_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_jan10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_feb10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_mar10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_apr10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_may10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_jun10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_jul10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_aug10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_sep10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_oct10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_nov10"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2010 <- left_join(CARE_SS_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_SS_2010)
CARE_SS_2010 <- CARE_SS_2010 %>% rename(c("SS_dec10"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2010, path="CARE_fILD_2010_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_jan11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_feb11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_mar11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_apr11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_may11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_jun11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_jul11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_aug11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_sep11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_oct11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_nov11"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2011 <- left_join(CARE_SS_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_SS_2011)
CARE_SS_2011 <- CARE_SS_2011 %>% rename(c("SS_dec11"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2011, path="CARE_fILD_2011_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_jan12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_feb12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_mar12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_apr12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_may12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_jun12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_jul12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_aug12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_sep12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_oct12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_nov12"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2012 <- left_join(CARE_SS_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_SS_2012)
CARE_SS_2012 <- CARE_SS_2012 %>% rename(c("SS_dec12"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2012, path="CARE_fILD_2012_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_jan13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_feb13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_mar13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_apr13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_may13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_jun13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_jul13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_aug13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_sep13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_oct13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_nov13"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2013 <- left_join(CARE_SS_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_SS_2013)
CARE_SS_2013 <- CARE_SS_2013 %>% rename(c("SS_dec13"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2013, path="CARE_fILD_2013_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_jan14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_feb14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_mar14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_apr14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_may14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_jun14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_jul14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_aug14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_sep14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_oct14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_nov14"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2014 <- left_join(CARE_SS_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_SS_2014)
CARE_SS_2014 <- CARE_SS_2014 %>% rename(c("SS_dec14"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2014, path="CARE_fILD_2014_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_jan15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_feb15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_mar15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_apr15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_may15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_jun15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_jul15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_aug15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_sep15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_oct15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_nov15"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2015 <- left_join(CARE_SS_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_SS_2015)
CARE_SS_2015 <- CARE_SS_2015 %>% rename(c("SS_dec15"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2015, path="CARE_fILD_2015_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_jan16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_feb16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_mar16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_apr16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_may16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_jun16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_jul16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_aug16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_sep16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_oct16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_nov16"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2016 <- left_join(CARE_SS_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_SS_2016)
CARE_SS_2016 <- CARE_SS_2016 %>% rename(c("SS_dec16"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2016, path="CARE_fILD_2016_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_jan17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_feb17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_mar17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_apr17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_may17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_jun17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_jul17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_aug17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_sep17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_oct17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_nov17"="SS"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SS_2017 <- left_join(CARE_SS_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_SS_2017)
CARE_SS_2017 <- CARE_SS_2017 %>% rename(c("SS_dec17"="SS"))
```
...
```{r}
write_xlsx(CARE_SS_2017, path="CARE_fILD_2017_SS_2021_11_05.xlsx")
system("say Just finished!")
```
...
# CSSbine all CARE_SS files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_SS <- list(CARE_SS_2000, CARE_SS_2001, CARE_SS_2002, CARE_SS_2003, CARE_SS_2004, CARE_SS_2005, CARE_SS_2006, CARE_SS_2007, CARE_SS_2008, CARE_SS_2009, CARE_SS_2010, CARE_SS_2011, CARE_SS_2012, CARE_SS_2013, CARE_SS_2014, CARE_SS_2015, CARE_SS_2016, CARE_SS_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_SS, path="CARE_fILD_2000_2017_SS_2021_11_05.xlsx")
```
