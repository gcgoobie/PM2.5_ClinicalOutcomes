...
```{r}
outfile1 <- here::here("CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_BC_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_jan00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_feb00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_mar00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_apr00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_may00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_jun00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_jul00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_aug00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_sep00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_oct00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_nov00"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2000 <- left_join(CARE_BC_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_BC_2000)
CARE_BC_2000 <- CARE_BC_2000 %>% rename(c("BC_dec00"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2000, path="CARE_fILD_2000_BC_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_jan01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_feb01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_mar01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_apr01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_may01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_jun01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_jul01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_aug01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_sep01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_oct01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_nov01"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2001 <- left_join(CARE_BC_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_BC_2001)
CARE_BC_2001 <- CARE_BC_2001 %>% rename(c("BC_dec01"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2001, path="CARE_fILD_2001_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_jan02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_feb02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_mar02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_apr02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_may02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_jun02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_jul02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_aug02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_sep02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_oct02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_nov02"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2002 <- left_join(CARE_BC_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_BC_2002)
CARE_BC_2002 <- CARE_BC_2002 %>% rename(c("BC_dec02"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2002, path="CARE_fILD_2002_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_jan03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_feb03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_mar03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_apr03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_may03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_jun03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_jul03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_aug03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_sep03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_oct03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_nov03"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2003 <- left_join(CARE_BC_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_BC_2003)
CARE_BC_2003 <- CARE_BC_2003 %>% rename(c("BC_dec03"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2003, path="CARE_fILD_2003_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_jan04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_feb04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_mar04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_apr04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_may04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_jun04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_jul04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_aug04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_sep04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_oct04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_nov04"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2004 <- left_join(CARE_BC_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_BC_2004)
CARE_BC_2004 <- CARE_BC_2004 %>% rename(c("BC_dec04"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2004, path="CARE_fILD_2004_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_jan05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_feb05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_mar05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_apr05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_may05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_jun05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_jul05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_aug05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_sep05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_oct05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_nov05"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2005 <- left_join(CARE_BC_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_BC_2005)
CARE_BC_2005 <- CARE_BC_2005 %>% rename(c("BC_dec05"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2005, path="CARE_fILD_2005_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_jan06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_feb06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_mar06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_apr06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_may06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_jun06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_jul06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_aug06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_sep06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_oct06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_nov06"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2006 <- left_join(CARE_BC_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_BC_2006)
CARE_BC_2006 <- CARE_BC_2006 %>% rename(c("BC_dec06"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2006, path="CARE_fILD_2006_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_jan07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_feb07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_mar07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_apr07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_may07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_jun07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_jul07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_aug07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_sep07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_oct07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_nov07"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2007 <- left_join(CARE_BC_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_BC_2007)
CARE_BC_2007 <- CARE_BC_2007 %>% rename(c("BC_dec07"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2007, path="CARE_fILD_2007_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_jan08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_feb08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_mar08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_apr08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_may08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_jun08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_jul08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_aug08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_sep08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_oct08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_nov08"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2008 <- left_join(CARE_BC_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_BC_2008)
CARE_BC_2008 <- CARE_BC_2008 %>% rename(c("BC_dec08"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2008, path="CARE_fILD_2008_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_jan09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_feb09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_mar09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_apr09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_may09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_jun09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_jul09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_aug09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_sep09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_oct09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_nov09"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2009 <- left_join(CARE_BC_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_BC_2009)
CARE_BC_2009 <- CARE_BC_2009 %>% rename(c("BC_dec09"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2009, path="CARE_fILD_2009_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_jan10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_feb10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_mar10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_apr10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_may10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_jun10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_jul10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_aug10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_sep10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_oct10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_nov10"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2010 <- left_join(CARE_BC_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_BC_2010)
CARE_BC_2010 <- CARE_BC_2010 %>% rename(c("BC_dec10"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2010, path="CARE_fILD_2010_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_jan11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_feb11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_mar11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_apr11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_may11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_jun11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_jul11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_aug11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_sep11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_oct11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_nov11"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2011 <- left_join(CARE_BC_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_BC_2011)
CARE_BC_2011 <- CARE_BC_2011 %>% rename(c("BC_dec11"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2011, path="CARE_fILD_2011_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_jan12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_feb12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_mar12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_apr12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_may12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_jun12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_jul12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_aug12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_sep12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_oct12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_nov12"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2012 <- left_join(CARE_BC_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_BC_2012)
CARE_BC_2012 <- CARE_BC_2012 %>% rename(c("BC_dec12"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2012, path="CARE_fILD_2012_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_jan13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_feb13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_mar13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_apr13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_may13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_jun13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_jul13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_aug13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_sep13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_oct13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_nov13"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2013 <- left_join(CARE_BC_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_BC_2013)
CARE_BC_2013 <- CARE_BC_2013 %>% rename(c("BC_dec13"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2013, path="CARE_fILD_2013_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_jan14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_feb14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_mar14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_apr14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_may14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_jun14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_jul14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_aug14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_sep14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_oct14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_nov14"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2014 <- left_join(CARE_BC_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_BC_2014)
CARE_BC_2014 <- CARE_BC_2014 %>% rename(c("BC_dec14"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2014, path="CARE_fILD_2014_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_jan15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_feb15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_mar15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_apr15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_may15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_jun15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_jul15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_aug15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_sep15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_oct15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_nov15"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2015 <- left_join(CARE_BC_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_BC_2015)
CARE_BC_2015 <- CARE_BC_2015 %>% rename(c("BC_dec15"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2015, path="CARE_fILD_2015_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_jan16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_feb16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_mar16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_apr16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_may16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_jun16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_jul16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_aug16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_sep16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_oct16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_nov16"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2016 <- left_join(CARE_BC_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_BC_2016)
CARE_BC_2016 <- CARE_BC_2016 %>% rename(c("BC_dec16"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2016, path="CARE_fILD_2016_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_jan17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_feb17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_mar17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_apr17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_may17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_jun17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_jul17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_aug17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_sep17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_oct17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_nov17"="BC"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_BC_2017 <- left_join(CARE_BC_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_BC_2017)
CARE_BC_2017 <- CARE_BC_2017 %>% rename(c("BC_dec17"="BC"))
```
...
```{r}
write_xlsx(CARE_BC_2017, path="CARE_fILD_2017_BC_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Combine all CARE_BC files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_BC <- list(CARE_BC_2000, CARE_BC_2001, CARE_BC_2002, CARE_BC_2003, CARE_BC_2004, CARE_BC_2005, CARE_BC_2006, CARE_BC_2007, CARE_BC_2008, CARE_BC_2009, CARE_BC_2010, CARE_BC_2011, CARE_BC_2012, CARE_BC_2013, CARE_BC_2014, CARE_BC_2015, CARE_BC_2016, CARE_BC_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_BC, path="CARE_fILD_2000_2017_BC_2021_11_05.xlsx")
```
