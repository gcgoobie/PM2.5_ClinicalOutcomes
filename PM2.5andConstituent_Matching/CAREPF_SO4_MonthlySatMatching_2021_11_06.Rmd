...
```{r}
outfile1 <- here::here("MonthlySO4Data/CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_SO4_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_jan00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_feb00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_mar00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_apr00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_may00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_jun00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_jul00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_aug00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_sep00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_oct00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_nov00"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2000 <- left_join(CARE_SO4_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_SO4_2000)
CARE_SO4_2000 <- CARE_SO4_2000 %>% rename(c("SO4_dec00"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2000, path="CARE_fILD_2000_SO4_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_jan01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_feb01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_mar01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_apr01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_may01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_jun01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_jul01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_aug01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_sep01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_oct01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_nov01"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2001 <- left_join(CARE_SO4_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_SO4_2001)
CARE_SO4_2001 <- CARE_SO4_2001 %>% rename(c("SO4_dec01"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2001, path="CARE_fILD_2001_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_jan02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_feb02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_mar02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_apr02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_may02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_jun02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_jul02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_aug02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_sep02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_oct02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_nov02"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2002 <- left_join(CARE_SO4_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_SO4_2002)
CARE_SO4_2002 <- CARE_SO4_2002 %>% rename(c("SO4_dec02"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2002, path="CARE_fILD_2002_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_jan03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_feb03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_mar03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_apr03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_may03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_jun03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_jul03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_aug03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_sep03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_oct03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_nov03"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2003 <- left_join(CARE_SO4_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_SO4_2003)
CARE_SO4_2003 <- CARE_SO4_2003 %>% rename(c("SO4_dec03"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2003, path="CARE_fILD_2003_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_jan04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_feb04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_mar04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_apr04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_may04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_jun04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_jul04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_aug04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_sep04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_oct04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_nov04"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2004 <- left_join(CARE_SO4_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_SO4_2004)
CARE_SO4_2004 <- CARE_SO4_2004 %>% rename(c("SO4_dec04"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2004, path="CARE_fILD_2004_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_jan05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_feb05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_mar05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_apr05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_may05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_jun05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_jul05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_aug05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_sep05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_oct05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_nov05"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2005 <- left_join(CARE_SO4_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_SO4_2005)
CARE_SO4_2005 <- CARE_SO4_2005 %>% rename(c("SO4_dec05"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2005, path="CARE_fILD_2005_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_jan06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_feb06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_mar06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_apr06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_may06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_jun06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_jul06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_aug06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_sep06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_oct06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_nov06"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2006 <- left_join(CARE_SO4_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_SO4_2006)
CARE_SO4_2006 <- CARE_SO4_2006 %>% rename(c("SO4_dec06"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2006, path="CARE_fILD_2006_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_jan07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_feb07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_mar07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_apr07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_may07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_jun07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_jul07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_aug07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_sep07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_oct07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_nov07"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2007 <- left_join(CARE_SO4_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_SO4_2007)
CARE_SO4_2007 <- CARE_SO4_2007 %>% rename(c("SO4_dec07"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2007, path="CARE_fILD_2007_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_jan08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_feb08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_mar08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_apr08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_may08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_jun08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_jul08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_aug08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_sep08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_oct08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_nov08"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2008 <- left_join(CARE_SO4_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_SO4_2008)
CARE_SO4_2008 <- CARE_SO4_2008 %>% rename(c("SO4_dec08"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2008, path="CARE_fILD_2008_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_jan09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_feb09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_mar09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_apr09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_may09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_jun09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_jul09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_aug09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_sep09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_oct09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_nov09"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2009 <- left_join(CARE_SO4_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_SO4_2009)
CARE_SO4_2009 <- CARE_SO4_2009 %>% rename(c("SO4_dec09"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2009, path="CARE_fILD_2009_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_jan10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_feb10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_mar10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_apr10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_may10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_jun10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_jul10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_aug10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_sep10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_oct10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_nov10"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2010 <- left_join(CARE_SO4_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_SO4_2010)
CARE_SO4_2010 <- CARE_SO4_2010 %>% rename(c("SO4_dec10"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2010, path="CARE_fILD_2010_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_jan11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_feb11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_mar11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_apr11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_may11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_jun11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_jul11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_aug11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_sep11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_oct11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_nov11"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2011 <- left_join(CARE_SO4_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_SO4_2011)
CARE_SO4_2011 <- CARE_SO4_2011 %>% rename(c("SO4_dec11"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2011, path="CARE_fILD_2011_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_jan12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_feb12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_mar12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_apr12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_may12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_jun12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_jul12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_aug12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_sep12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_oct12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_nov12"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2012 <- left_join(CARE_SO4_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_SO4_2012)
CARE_SO4_2012 <- CARE_SO4_2012 %>% rename(c("SO4_dec12"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2012, path="CARE_fILD_2012_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_jan13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_feb13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_mar13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_apr13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_may13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_jun13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_jul13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_aug13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_sep13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_oct13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_nov13"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2013 <- left_join(CARE_SO4_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_SO4_2013)
CARE_SO4_2013 <- CARE_SO4_2013 %>% rename(c("SO4_dec13"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2013, path="CARE_fILD_2013_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_jan14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_feb14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_mar14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_apr14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_may14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_jun14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_jul14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_aug14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_sep14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_oct14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_nov14"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2014 <- left_join(CARE_SO4_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_SO4_2014)
CARE_SO4_2014 <- CARE_SO4_2014 %>% rename(c("SO4_dec14"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2014, path="CARE_fILD_2014_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_jan15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_feb15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_mar15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_apr15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_may15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_jun15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_jul15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_aug15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_sep15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_oct15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_nov15"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2015 <- left_join(CARE_SO4_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_SO4_2015)
CARE_SO4_2015 <- CARE_SO4_2015 %>% rename(c("SO4_dec15"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2015, path="CARE_fILD_2015_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_jan16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_feb16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_mar16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_apr16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_may16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_jun16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_jul16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_aug16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_sep16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_oct16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_nov16"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2016 <- left_join(CARE_SO4_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_SO4_2016)
CARE_SO4_2016 <- CARE_SO4_2016 %>% rename(c("SO4_dec16"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2016, path="CARE_fILD_2016_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_jan17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_feb17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_mar17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_apr17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_may17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_jun17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_jul17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_aug17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_sep17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_oct17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_nov17"="SO4"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_SO4_2017 <- left_join(CARE_SO4_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_SO4_2017)
CARE_SO4_2017 <- CARE_SO4_2017 %>% rename(c("SO4_dec17"="SO4"))
```
...
```{r}
write_xlsx(CARE_SO4_2017, path="CARE_fILD_2017_SO4_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Combine all CARE_SO4 files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_SO4 <- list(CARE_SO4_2000, CARE_SO4_2001, CARE_SO4_2002, CARE_SO4_2003, CARE_SO4_2004, CARE_SO4_2005, CARE_SO4_2006, CARE_SO4_2007, CARE_SO4_2008, CARE_SO4_2009, CARE_SO4_2010, CARE_SO4_2011, CARE_SO4_2012, CARE_SO4_2013, CARE_SO4_2014, CARE_SO4_2015, CARE_SO4_2016, CARE_SO4_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_SO4, path="CARE_fILD_2000_2017_SO4_2021_11_05.xlsx")
```
