...
```{r}
outfile1 <- here::here("MonthlyOMData/CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_OM_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_jan00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_feb00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_mar00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_apr00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_may00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_jun00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_jul00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_aug00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_sep00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_oct00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_nov00"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2000 <- left_join(CARE_OM_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_OM_2000)
CARE_OM_2000 <- CARE_OM_2000 %>% rename(c("OM_dec00"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2000, path="CARE_fILD_2000_OM_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_jan01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_feb01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_mar01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_apr01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_may01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_jun01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_jul01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_aug01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_sep01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_oct01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_nov01"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2001 <- left_join(CARE_OM_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_OM_2001)
CARE_OM_2001 <- CARE_OM_2001 %>% rename(c("OM_dec01"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2001, path="CARE_fILD_2001_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_jan02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_feb02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_mar02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_apr02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_may02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_jun02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_jul02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_aug02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_sep02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_oct02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_nov02"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2002 <- left_join(CARE_OM_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_OM_2002)
CARE_OM_2002 <- CARE_OM_2002 %>% rename(c("OM_dec02"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2002, path="CARE_fILD_2002_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_jan03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_feb03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_mar03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_apr03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_may03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_jun03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_jul03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_aug03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_sep03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_oct03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_nov03"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2003 <- left_join(CARE_OM_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_OM_2003)
CARE_OM_2003 <- CARE_OM_2003 %>% rename(c("OM_dec03"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2003, path="CARE_fILD_2003_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_jan04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_feb04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_mar04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_apr04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_may04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_jun04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_jul04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_aug04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_sep04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_oct04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_nov04"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2004 <- left_join(CARE_OM_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_OM_2004)
CARE_OM_2004 <- CARE_OM_2004 %>% rename(c("OM_dec04"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2004, path="CARE_fILD_2004_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_jan05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_feb05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_mar05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_apr05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_may05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_jun05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_jul05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_aug05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_sep05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_oct05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_nov05"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2005 <- left_join(CARE_OM_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_OM_2005)
CARE_OM_2005 <- CARE_OM_2005 %>% rename(c("OM_dec05"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2005, path="CARE_fILD_2005_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_jan06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_feb06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_mar06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_apr06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_may06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_jun06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_jul06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_aug06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_sep06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_oct06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_nov06"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2006 <- left_join(CARE_OM_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_OM_2006)
CARE_OM_2006 <- CARE_OM_2006 %>% rename(c("OM_dec06"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2006, path="CARE_fILD_2006_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_jan07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_feb07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_mar07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_apr07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_may07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_jun07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_jul07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_aug07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_sep07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_oct07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_nov07"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2007 <- left_join(CARE_OM_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_OM_2007)
CARE_OM_2007 <- CARE_OM_2007 %>% rename(c("OM_dec07"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2007, path="CARE_fILD_2007_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_jan08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_feb08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_mar08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_apr08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_may08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_jun08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_jul08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_aug08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_sep08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_oct08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_nov08"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2008 <- left_join(CARE_OM_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_OM_2008)
CARE_OM_2008 <- CARE_OM_2008 %>% rename(c("OM_dec08"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2008, path="CARE_fILD_2008_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_jan09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_feb09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_mar09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_apr09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_may09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_jun09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_jul09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_aug09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_sep09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_oct09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_nov09"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2009 <- left_join(CARE_OM_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_OM_2009)
CARE_OM_2009 <- CARE_OM_2009 %>% rename(c("OM_dec09"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2009, path="CARE_fILD_2009_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_jan10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_feb10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_mar10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_apr10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_may10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_jun10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_jul10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_aug10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_sep10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_oct10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_nov10"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2010 <- left_join(CARE_OM_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_OM_2010)
CARE_OM_2010 <- CARE_OM_2010 %>% rename(c("OM_dec10"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2010, path="CARE_fILD_2010_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_jan11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_feb11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_mar11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_apr11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_may11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_jun11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_jul11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_aug11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_sep11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_oct11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_nov11"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2011 <- left_join(CARE_OM_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_OM_2011)
CARE_OM_2011 <- CARE_OM_2011 %>% rename(c("OM_dec11"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2011, path="CARE_fILD_2011_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_jan12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_feb12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_mar12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_apr12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_may12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_jun12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_jul12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_aug12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_sep12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_oct12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_nov12"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2012 <- left_join(CARE_OM_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_OM_2012)
CARE_OM_2012 <- CARE_OM_2012 %>% rename(c("OM_dec12"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2012, path="CARE_fILD_2012_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_jan13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_feb13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_mar13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_apr13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_may13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_jun13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_jul13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_aug13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_sep13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_oct13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_nov13"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2013 <- left_join(CARE_OM_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_OM_2013)
CARE_OM_2013 <- CARE_OM_2013 %>% rename(c("OM_dec13"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2013, path="CARE_fILD_2013_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_jan14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_feb14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_mar14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_apr14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_may14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_jun14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_jul14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_aug14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_sep14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_oct14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_nov14"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2014 <- left_join(CARE_OM_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_OM_2014)
CARE_OM_2014 <- CARE_OM_2014 %>% rename(c("OM_dec14"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2014, path="CARE_fILD_2014_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_jan15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_feb15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_mar15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_apr15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_may15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_jun15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_jul15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_aug15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_sep15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_oct15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_nov15"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2015 <- left_join(CARE_OM_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_OM_2015)
CARE_OM_2015 <- CARE_OM_2015 %>% rename(c("OM_dec15"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2015, path="CARE_fILD_2015_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_jan16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_feb16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_mar16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_apr16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_may16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_jun16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_jul16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_aug16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_sep16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_oct16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_nov16"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2016 <- left_join(CARE_OM_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_OM_2016)
CARE_OM_2016 <- CARE_OM_2016 %>% rename(c("OM_dec16"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2016, path="CARE_fILD_2016_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_jan17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_feb17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_mar17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_apr17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_may17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_jun17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_jul17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_aug17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_sep17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_oct17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_nov17"="OM"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_OM_2017 <- left_join(CARE_OM_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_OM_2017)
CARE_OM_2017 <- CARE_OM_2017 %>% rename(c("OM_dec17"="OM"))
```
...
```{r}
write_xlsx(CARE_OM_2017, path="CARE_fILD_2017_OM_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Combine all CARE_OM files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_OM <- list(CARE_OM_2000, CARE_OM_2001, CARE_OM_2002, CARE_OM_2003, CARE_OM_2004, CARE_OM_2005, CARE_OM_2006, CARE_OM_2007, CARE_OM_2008, CARE_OM_2009, CARE_OM_2010, CARE_OM_2011, CARE_OM_2012, CARE_OM_2013, CARE_OM_2014, CARE_OM_2015, CARE_OM_2016, CARE_OM_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_OM, path="CARE_fILD_2000_2017_OM_2021_11_05.xlsx")
```
