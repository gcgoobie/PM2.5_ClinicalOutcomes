...
```{r}
outfile1 <- here::here("MonthlyNO3Data/CAREPF_fILD_PM25_BaselineData_2021_10_25.xlsx")
...
CARE_NIT_2000 <- left_join(match, df_jan00, by="nrow")
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_jan00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_feb00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_feb00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_mar00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_mar00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_apr00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_apr00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_may00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_may00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_jun00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_jun00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_jul00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_jul00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_aug00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_aug00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_sep00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_sep00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_oct00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_oct00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_nov00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_nov00"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2000 <- left_join(CARE_NIT_2000, df_dec00, by=c("nrow","lon","lat"))
str(CARE_NIT_2000)
CARE_NIT_2000 <- CARE_NIT_2000 %>% rename(c("NIT_dec00"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2000, path="CARE_fILD_2000_NIT_2021_11_05.xlsx")
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(match, df_jan01, by="nrow")
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_jan01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_feb01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_feb01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_mar01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_mar01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_apr01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_apr01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_may01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_may01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_jun01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_jun01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_jul01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_jul01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_aug01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_aug01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_sep01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_sep01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_oct01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_oct01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_nov01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_nov01"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2001 <- left_join(CARE_NIT_2001, df_dec01, by=c("nrow","lon","lat"))
str(CARE_NIT_2001)
CARE_NIT_2001 <- CARE_NIT_2001 %>% rename(c("NIT_dec01"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2001, path="CARE_fILD_2001_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(match, df_jan02, by="nrow")
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_jan02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_feb02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_feb02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_mar02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_mar02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_apr02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_apr02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_may02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_may02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_jun02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_jun02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_jul02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_jul02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_aug02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_aug02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_sep02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_sep02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_oct02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_oct02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_nov02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_nov02"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2002 <- left_join(CARE_NIT_2002, df_dec02, by=c("nrow","lon","lat"))
str(CARE_NIT_2002)
CARE_NIT_2002 <- CARE_NIT_2002 %>% rename(c("NIT_dec02"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2002, path="CARE_fILD_2002_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(match, df_jan03, by="nrow")
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_jan03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_feb03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_feb03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_mar03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_mar03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_apr03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_apr03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_may03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_may03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_jun03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_jun03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_jul03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_jul03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_aug03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_aug03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_sep03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_sep03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_oct03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_oct03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_nov03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_nov03"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2003 <- left_join(CARE_NIT_2003, df_dec03, by=c("nrow","lon","lat"))
str(CARE_NIT_2003)
CARE_NIT_2003 <- CARE_NIT_2003 %>% rename(c("NIT_dec03"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2003, path="CARE_fILD_2003_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(match, df_jan04, by="nrow")
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_jan04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_feb04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_feb04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_mar04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_mar04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_apr04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_apr04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_may04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_may04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_jun04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_jun04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_jul04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_jul04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_aug04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_aug04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_sep04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_sep04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_oct04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_oct04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_nov04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_nov04"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2004 <- left_join(CARE_NIT_2004, df_dec04, by=c("nrow","lon","lat"))
str(CARE_NIT_2004)
CARE_NIT_2004 <- CARE_NIT_2004 %>% rename(c("NIT_dec04"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2004, path="CARE_fILD_2004_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(match, df_jan05, by="nrow")
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_jan05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_feb05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_feb05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_mar05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_mar05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_apr05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_apr05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_may05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_may05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_jun05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_jun05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_jul05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_jul05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_aug05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_aug05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_sep05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_sep05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_oct05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_oct05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_nov05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_nov05"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2005 <- left_join(CARE_NIT_2005, df_dec05, by=c("nrow","lon","lat"))
str(CARE_NIT_2005)
CARE_NIT_2005 <- CARE_NIT_2005 %>% rename(c("NIT_dec05"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2005, path="CARE_fILD_2005_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(match, df_jan06, by="nrow")
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_jan06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_feb06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_feb06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_mar06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_mar06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_apr06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_apr06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_may06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_may06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_jun06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_jun06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_jul06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_jul06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_aug06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_aug06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_sep06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_sep06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_oct06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_oct06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_nov06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_nov06"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2006 <- left_join(CARE_NIT_2006, df_dec06, by=c("nrow","lon","lat"))
str(CARE_NIT_2006)
CARE_NIT_2006 <- CARE_NIT_2006 %>% rename(c("NIT_dec06"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2006, path="CARE_fILD_2006_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(match, df_jan07, by="nrow")
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_jan07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_feb07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_feb07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_mar07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_mar07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_apr07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_apr07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_may07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_may07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_jun07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_jun07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_jul07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_jul07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_aug07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_aug07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_sep07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_sep07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_oct07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_oct07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_nov07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_nov07"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2007 <- left_join(CARE_NIT_2007, df_dec07, by=c("nrow","lon","lat"))
str(CARE_NIT_2007)
CARE_NIT_2007 <- CARE_NIT_2007 %>% rename(c("NIT_dec07"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2007, path="CARE_fILD_2007_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(match, df_jan08, by="nrow")
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_jan08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_feb08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_feb08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_mar08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_mar08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_apr08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_apr08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_may08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_may08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_jun08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_jun08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_jul08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_jul08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_aug08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_aug08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_sep08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_sep08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_oct08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_oct08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_nov08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_nov08"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2008 <- left_join(CARE_NIT_2008, df_dec08, by=c("nrow","lon","lat"))
str(CARE_NIT_2008)
CARE_NIT_2008 <- CARE_NIT_2008 %>% rename(c("NIT_dec08"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2008, path="CARE_fILD_2008_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(match, df_jan09, by="nrow")
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_jan09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_feb09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_feb09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_mar09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_mar09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_apr09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_apr09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_may09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_may09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_jun09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_jun09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_jul09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_jul09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_aug09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_aug09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_sep09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_sep09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_oct09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_oct09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_nov09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_nov09"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2009 <- left_join(CARE_NIT_2009, df_dec09, by=c("nrow","lon","lat"))
str(CARE_NIT_2009)
CARE_NIT_2009 <- CARE_NIT_2009 %>% rename(c("NIT_dec09"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2009, path="CARE_fILD_2009_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(match, df_jan10, by="nrow")
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_jan10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_feb10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_feb10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_mar10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_mar10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_apr10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_apr10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_may10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_may10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_jun10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_jun10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_jul10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_jul10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_aug10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_aug10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_sep10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_sep10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_oct10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_oct10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_nov10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_nov10"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2010 <- left_join(CARE_NIT_2010, df_dec10, by=c("nrow","lon","lat"))
str(CARE_NIT_2010)
CARE_NIT_2010 <- CARE_NIT_2010 %>% rename(c("NIT_dec10"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2010, path="CARE_fILD_2010_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(match, df_jan11, by="nrow")
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_jan11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_feb11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_feb11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_mar11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_mar11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_apr11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_apr11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_may11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_may11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_jun11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_jun11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_jul11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_jul11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_aug11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_aug11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_sep11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_sep11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_oct11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_oct11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_nov11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_nov11"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2011 <- left_join(CARE_NIT_2011, df_dec11, by=c("nrow","lon","lat"))
str(CARE_NIT_2011)
CARE_NIT_2011 <- CARE_NIT_2011 %>% rename(c("NIT_dec11"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2011, path="CARE_fILD_2011_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(match, df_jan12, by="nrow")
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_jan12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_feb12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_feb12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_mar12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_mar12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_apr12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_apr12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_may12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_may12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_jun12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_jun12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_jul12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_jul12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_aug12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_aug12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_sep12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_sep12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_oct12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_oct12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_nov12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_nov12"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2012 <- left_join(CARE_NIT_2012, df_dec12, by=c("nrow","lon","lat"))
str(CARE_NIT_2012)
CARE_NIT_2012 <- CARE_NIT_2012 %>% rename(c("NIT_dec12"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2012, path="CARE_fILD_2012_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(match, df_jan13, by="nrow")
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_jan13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_feb13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_feb13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_mar13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_mar13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_apr13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_apr13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_may13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_may13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_jun13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_jun13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_jul13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_jul13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_aug13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_aug13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_sep13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_sep13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_oct13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_oct13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_nov13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_nov13"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2013 <- left_join(CARE_NIT_2013, df_dec13, by=c("nrow","lon","lat"))
str(CARE_NIT_2013)
CARE_NIT_2013 <- CARE_NIT_2013 %>% rename(c("NIT_dec13"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2013, path="CARE_fILD_2013_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(match, df_jan14, by="nrow")
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_jan14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_feb14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_feb14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_mar14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_mar14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_apr14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_apr14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_may14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_may14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_jun14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_jun14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_jul14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_jul14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_aug14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_aug14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_sep14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_sep14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_oct14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_oct14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_nov14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_nov14"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2014 <- left_join(CARE_NIT_2014, df_dec14, by=c("nrow","lon","lat"))
str(CARE_NIT_2014)
CARE_NIT_2014 <- CARE_NIT_2014 %>% rename(c("NIT_dec14"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2014, path="CARE_fILD_2014_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(match, df_jan15, by="nrow")
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_jan15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_feb15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_feb15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_mar15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_mar15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_apr15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_apr15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_may15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_may15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_jun15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_jun15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_jul15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_jul15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_aug15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_aug15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_sep15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_sep15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_oct15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_oct15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_nov15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_nov15"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2015 <- left_join(CARE_NIT_2015, df_dec15, by=c("nrow","lon","lat"))
str(CARE_NIT_2015)
CARE_NIT_2015 <- CARE_NIT_2015 %>% rename(c("NIT_dec15"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2015, path="CARE_fILD_2015_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(match, df_jan16, by="nrow")
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_jan16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_feb16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_feb16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_mar16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_mar16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_apr16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_apr16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_may16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_may16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_jun16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_jun16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_jul16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_jul16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_aug16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_aug16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_sep16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_sep16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_oct16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_oct16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_nov16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_nov16"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2016 <- left_join(CARE_NIT_2016, df_dec16, by=c("nrow","lon","lat"))
str(CARE_NIT_2016)
CARE_NIT_2016 <- CARE_NIT_2016 %>% rename(c("NIT_dec16"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2016, path="CARE_fILD_2016_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(match, df_jan17, by="nrow")
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_jan17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_feb17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_feb17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_mar17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_mar17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_apr17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_apr17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_may17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_may17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_jun17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_jun17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_jul17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_jul17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_aug17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_aug17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_sep17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_sep17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_oct17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_oct17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_nov17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_nov17"="NIT"))
```
...
match$ID <- S_coord$ID
match <- match %>% rename(c("nrow"="nn.idx", "dist"="nn.dists"))
CARE_NIT_2017 <- left_join(CARE_NIT_2017, df_dec17, by=c("nrow","lon","lat"))
str(CARE_NIT_2017)
CARE_NIT_2017 <- CARE_NIT_2017 %>% rename(c("NIT_dec17"="NIT"))
```
...
```{r}
write_xlsx(CARE_NIT_2017, path="CARE_fILD_2017_NIT_2021_11_05.xlsx")
system("say Just finished!")
```
...
# Combine all CARE_NIT files
Will produce a dataframe that has a column for the PM2.5 value for each month
```{r}
CARE_NIT <- list(CARE_NIT_2000, CARE_NIT_2001, CARE_NIT_2002, CARE_NIT_2003, CARE_NIT_2004, CARE_NIT_2005, CARE_NIT_2006, CARE_NIT_2007, CARE_NIT_2008, CARE_NIT_2009, CARE_NIT_2010, CARE_NIT_2011, CARE_NIT_2012, CARE_NIT_2013, CARE_NIT_2014, CARE_NIT_2015, CARE_NIT_2016, CARE_NIT_2017) %>% reduce(left_join, by=c("nrow", "dist", "ID","lon","lat"))
```

## Convert that file into Excel for 2000-2018
```{r}
write_xlsx(CARE_NIT, path="CARE_fILD_2000_2017_NO3_2021_11_05.xlsx")
```
