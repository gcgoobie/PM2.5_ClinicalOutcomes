...
```{r}
PM <- PM %>% 
  pivot_longer(cols=c(51:277), names_to="PM_date", names_prefix="PM25_")
```
...
```{r}
PM <- PM %>% 
  mutate_at(c("dx_date", "consent_date", "death_date", "tx_date", "pft_date", "deathORtx_date", "DeathTxCensor_date", "PM_date"), as.Date)
str(PM)
```

## Remove unnecessary columns
```{r}
PM <- PM %>% dplyr::select(!c("nrow", "dist", "lat.x", "lon.x", "lon.y", "lat.y"))
```
...
```
This takes us down to 1424 observations.
...
```{r}
outfile4 <- here("Simmons_fILD_2000_2017_SO4_2021_11_07.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_NO3_2021_11_05.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_NH4_2021_11_05.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_BC_2021_11_05.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_OM_2021_11_05.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_SS_2021_11_05.xlsx")
...
```{r}
outfile4 <- here("Simm_fILD_2000_2017_soil_2021_11_05.xlsx")
...
```{r}
write_xlsx(PM, path="Simmons_fILD_AllConstituentsMatched_2022_07_28.xlsx")
```
...
exp(qc.survfit1$ci)
```
So the HR of the overall model is 2.13 (95% CI 1.89-2.40) and that is primarily driven by SO4, NH4, NO3, and OM
...
#Next construct the base cox model
survival::coxph(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat, data=PM)

#Next the quantile regression model
qc.survfit2 <- qgcomp.cox.noboot(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ ., expnms=Xnm, data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'time_DeathTxCensor', 'deadORtx')], q=4)
qc.survfit2
...
exp(qc.survfit2$ci)
```
So the HR of the overall model is 2.19 (95% CI 1.93-2.48) and that is primarily driven by SO4, NH4, NO3, OM, and soil
...
#Next construct the base cox model
survival::coxph(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat + dx_yr, data=PM)

#Next the quantile regression model
qc.survfit3 <- qgcomp.cox.noboot(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ ., expnms=Xnm, data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'dx_yr', 'time_DeathTxCensor', 'deadORtx')], q=4)
qc.survfit3
...
exp(qc.survfit3$ci)
```
So the HR of the overall model is 7.63 (95% CI 6.34-9.19) and that is primarily driven by SO4, NH4, OM, NO3, and SS
...
qc.fit1
```
**So this tells us that the overall mixture beta=-4.94, indicating that for each 1 quantile increase of the mixture, the baseline FVC decreases by 4.94 units % predicted.** 
This negative effect on FVC is primarily driven by NH4 > SO4 > OM > NO3
...
lm(fvc_pct ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat, data=PM)


qc.fit2 <- qgcomp.noboot(fvc_pct~.,data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'fvc_pct')], expnms=Xnm, family=gaussian(), q=4)

qc.fit2
```
**So this tells us that the overall mixture beta=-4.44, indicating that for each 1 quantile increase of the mixture, the baseline FVC decreases by 4.44 units % predicted.** 
This negative effect on FVC is primarily driven by NH4 > SO4 > OM > NO3
...
lm(fvc_pct ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat + dx_yr, data=PM)


qc.fit3 <- qgcomp.noboot(fvc_pct~.,data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'dx_yr', 'fvc_pct')], expnms=Xnm, family=gaussian(), q=4)

qc.fit3
```
**So this tells us that the overall mixture beta=-5.27, indicating that for each 1 quantile increase of the mixture, the baseline FVC decreases by 5.27 units % predicted.** 
This negative effect on FVC is primarily driven by NH4 > SO4 > OM > NO3
...
qc.fit1
```
**So this tells us that the overall mixture beta=-3.82, indicating that for each 1 quantile increase of the mixture, the baseline DLCO decreases by 3.82 units % predicted.** 
This negative effect on DLCO is primarily driven by SO4 > NH4 > OM > Soil > NO3
...
lm(dlco_pct ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat, data=PM)


qc.fit2 <- qgcomp.noboot(dlco_pct~.,data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'dlco_pct')], expnms=Xnm, family=gaussian(), q=4)

qc.fit2
```
**So this tells us that the overall mixture beta=-4.14, indicating that for each 1 quantile increase of the mixture, the baseline DLCO decreases by 4.14 units % predicted.** 
This negative effect on DLCO is primarily driven by SO4 > NH4 > OM > NO3 > Soil
...
lm(dlco_pct ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat + dx_yr, data=PM)


qc.fit3 <- qgcomp.noboot(dlco_pct~.,data=PM[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'dx_yr', 'dlco_pct')], expnms=Xnm, family=gaussian(), q=4)

qc.fit3
```
**So this tells us that the overall mixture beta=-6.90, indicating that for each 1 quantile increase of the mixture, the baseline DLCO decreases by 6.90 units % predicted.** 
This negative effect on DLCO is primarily driven by SO4 > NH4 > OM > SS > NO3 > Soil
...
exp(qc.survfit1$ci)
```
So the HR of the overall model is 2.13 (95% CI 1.88-2.41) and that is primarily driven by NH4, Soil, OM and SS
...
#Next construct the base cox model
survival::coxph(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ SO4_5yrPreCensor + NH4_5yrPreCensor + NO3_5yrPreCensor + BC_5yrPreCensor + OM_5yrPreCensor + SS_5yrPreCensor + Soil_5yrPreCensor + age_dx + sex + smokeHx + dich_Race + ADI_nat, data=PMx)

#Next the quantile regression model
set.seed(5)
qc.survfit2 <- qgcomp.cox.boot(survival::Surv(time_DeathTxCensor, deadORtx==1) ~ ., expnms=Xnm, data=PMx[,c(Xnm, 'age_dx', 'sex', 'smokeHx', 'dich_Race', 'ADI_nat', 'time_DeathTxCensor', 'deadORtx')], q=4, parallel=T)
qc.survfit2
...
exp(qc.survfit2$ci)
```
So the HR of the overall model is 1.89 (95% CI 1.65-2.16) and that is primarily driven by NH4, OM, and soil
